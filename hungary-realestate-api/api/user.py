...
@app02.post("/create_user", response_model=schemas.ReadUser)
...
@app02.post("/update_user")
def update_user(db: Session = Depends(get_db), user_id: int = 0, u_fullname: Optional[str] = None, u_contact: Optional[int] = None, u_email: Optional[str] = None):
